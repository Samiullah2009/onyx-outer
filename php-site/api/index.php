  ...
  <section class="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto reveal" id="blog">
    <div class="glass rounded-2xl p-8 sm:p-16 text-center relative overflow-hidden">
      ...
      <div class="relative">
        ...
        <a href="/journal" class="btn-luxury inline-block px-8 py-3 border border-gold/40 text-gold text-sm uppercase tracking-wider rounded-sm hover:bg-gold/10 transition-all animate-bounce">Read The Journal</a>
      </div>
    </div>
  </section>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
      ...
      <div>
        ...
        <ul class="space-y-2 text-xs text-silver/60">
          ...
          <li><a href="/page/contact" class="hover:text-gold transition-colors">Contact</a></li>
          <li><a href="/journal" class="hover:text-gold transition-colors">Journal</a></li>
          <li><a href="/page/faq" class="hover:text-gold transition-colors">FAQ</a></li>
        </ul>
      </div>
      <div>
        <h4 class="font-display text-sm text-white mb-4">Legal</h4>
        <ul class="space-y-2 text-xs text-silver/60">
          <li><a href="/page/privacy-policy" class="hover:text-gold transition-colors">Privacy Policy</a></li>
          <li><a href="/page/terms-conditions" class="hover:text-gold transition-colors">Terms &amp; Conditions</a></li>
          <li><a href="/page/affiliate-disclosure" class="hover:text-gold transition-colors">Affiliate Disclosure</a></li>
          <li><a href="/page/editorial-policy" class="hover:text-gold transition-colors">Editorial Policy</a></li>
        </ul>
      </div>
      <div>
